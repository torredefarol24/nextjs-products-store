...
export default function DeployPage() {
	...
	return (
		<main
			className="bg-neutral-50 flex flex-col items-center p-5"
			style={{ marginBottom: `${detailHeight}px` }}
		>
			<div className="mt-6 flex w-full max-w-[40em] items-center justify-center lg:mt-8">
				<div className="rounded-[25%] border border-[#19191C0A] bg-[#F9F9FA] p-3 shadow-[0px_9.36px_9.36px_0px_hsla(0,0%,0%,0.04)]">
					<div className="rounded-[25%] border border-[#FAFAFB] bg-white p-5 shadow-[0px_2px_12px_0px_hsla(0,0%,0%,0.03)] lg:p-9"></div>
				</div>
				<div
					className={`flex w-9 items-center transition-opacity duration-[2500ms] ${status === "success" ? "opacity-100" : "opacity-0"}`}
				>
					<div className="to-[rgba(253, 54, 110, 0.15)] h-[1px] flex-1 bg-gradient-to-l from-[#f02e65]"></div>
					<div className="flex h-5 w-5 items-center justify-center rounded-full border border-[#FD366E52] bg-[#FD366E14] text-[#FD366E]"></div>
			...
			<div className="grid grid-rows-3 gap-7 lg:grid-cols-3 lg:grid-rows-none">
				<div className="flex h-full w-72 flex-col gap-2 rounded-md border border-[#EDEDF0] bg-white p-4">
					...
					<p>
						Edit <code className="rounded-sm bg-[#EDEDF0] p-1">app/page.js</code> to get started
				...
				<a href="https://cloud.appwrite.io" target="_blank" rel="noopener noreferrer">
					<div className="flex h-full w-72 flex-col gap-2 rounded-md border border-[#EDEDF0] bg-white p-4">
						<div className="flex flex-row items-center justify-between">
							...
							<span className="inline-block text-[#D8D8DB]"></span>
						</div>
